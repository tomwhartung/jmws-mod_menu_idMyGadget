...
<?php if ( $jmwsIdMyGadget->phoneBurgerIconThisDeviceRight ) : ?>
	<div data-role="page" id="phone-burger-menu-right">
		<?php
			if ( $module->showtitle )
			{
				...
				print '<div data-role="header" data-add-back-btn="true">';
				print '<' . $headerTag . ' class="' . $headerClass . '">' . $module->title . '</' . $headerTag . '>';
				print '</div>';
			}
		?>
